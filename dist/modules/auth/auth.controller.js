...
router.patch("/send-verify-password", (0, validation_middleware_1.validation)(validators.verifyPasswordCode), auth_service_1.default.verifyPasswordCode);
router.patch("/reset-verify-password", (0, validation_middleware_1.validation)(validators.resetVerifyPassword), auth_service_1.default.resetVerifyPassword);
